...
class AccessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create access" do
    assert_difference('Access.count') do
      post accesses_url, params: { access: { date: @access.date, nationality: @access.nationality, os: @access.os } }
    end
  ...
  test "should update access" do
    patch access_url(@access), params: { access: { date: @access.date, nationality: @access.nationality, os: @access.os } }
