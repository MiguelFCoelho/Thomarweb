...
class PoisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poi" do
    assert_difference('Poi.count') do
      post pois_url, params: { poi: { description: @poi.description, image: @poi.image, latitude: @poi.latitude, longitude: @poi.longitude, name: @poi.name } }
    end
  ...
  test "should update poi" do
    patch poi_url(@poi), params: { poi: { description: @poi.description, image: @poi.image, latitude: @poi.latitude, longitude: @poi.longitude, name: @poi.name } }
