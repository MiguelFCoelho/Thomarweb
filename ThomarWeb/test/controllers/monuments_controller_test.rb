...
class MonumentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create monument" do
    assert_difference('Monument.count') do
      post monuments_url, params: { monument: { address: @monument.address, description: @monument.description, image: @monument.image, latitude: @monument.latitude, longitude: @monument.longitude, name: @monument.name } }
    end
  ...
  test "should update monument" do
    patch monument_url(@monument), params: { monument: { address: @monument.address, description: @monument.description, image: @monument.image, latitude: @monument.latitude, longitude: @monument.longitude, name: @monument.name } }
